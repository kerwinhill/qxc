...
public interface LotteryResultMapper {
    ...
    @Select("select \n" +
            "\tresult.id,result.codeid,result.year,result.timer,result.b1,\n" +
            "\tsc1.code b1code,sc1.color b1color,sc1.shengxiao b1shengxiao,sc1.jmsht b1jmsht,\n" +
            "\tsc2.code b2code,sc2.color b2color,sc2.shengxiao b2shengxiao,sc2.jmsht b2jmsht,\n" +
            "\tsc3.code b3code,sc3.color b3color,sc3.shengxiao b3shengxiao,sc3.jmsht b3jmsht,\n" +
            "\tsc4.code b4code,sc4.color b4color,sc4.shengxiao b4shengxiao,sc4.jmsht b4jmsht,\n" +
            "\tsc5.code b5code,sc5.color b5color,sc5.shengxiao b5shengxiao,sc5.jmsht b5jmsht,\n" +
            "\tsc6.code b6code,sc6.color b6color,sc6.shengxiao b6shengxiao,sc6.jmsht b6jmsht,\n" +
            "\tsc7.code b7code,sc7.color b7color,sc7.shengxiao b7shengxiao,sc7.jmsht b7jmsht\n" +
